...
1. Fork in GitHub https://github.com/atsign-labs/REPO
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/REPO`)
3. Set your remotes as follows:

   ```sh
   cd REPO
   git remote add upstream git@github.com:atsign-labs/REPO.git
   ...
   upstream        git@github.com:atsign-labs/REPO.git (fetch)
...
The Atsign Labs publishes libraries and widgets to
